...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: "HR matching system for candidates and job positions with advanced filtering.",
    glowClass: "hr-glow",
    illustration: () => (
      <div className="project-artwork hr-art">
        ...
        <div className="hr-match-mock">
          <div className="hr-header-box">
            <FaUserCheck />
            <span>RECRUITMENT MATCHER</span>
          </div>
          <div className="matcher-results">
            <div className="result-row"><span>Candidate FIT</span> <span className="match-ok">98%</span></div>
            <div className="match-bar-container"><div className="match-fill" /></div>
          </div>
        </div>
        <div className="floating-badge indigo-badge">Matching / Analytics</div>
      </div>
    )
  }
];
